...
- (void)runWithDevice:(IOBluetoothDevice *)device
{
    id<IOBluetoothDevicePair_ClassMethods> factory =
        (id<IOBluetoothDevicePair_ClassMethods>)NSClassFromString(
...
- (NSData *)makePINCodeForDevice:(IOBluetoothDevice *)device
{
    ...
    {
        address =
            [[(id<IOBluetoothHostController_ClassMethods>)NSClassFromString(
...
- (void)devicePairingFinished:(id<IOBluetoothDevicePair_Methods>)sender
