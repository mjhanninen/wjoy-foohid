...
+ (void)subscribeToNotifications:(WiimoteEventSystem *)system
{
    ...
    while (name != nil)
    {
        ...
        [center addObserver:system selector:selector name:name object:nil];
...
- (void)addObserver:(id)observer { [m_Observers addObject:observer]; }

- (void)removeObserver:(id)observer { [m_Observers removeObject:observer]; }
