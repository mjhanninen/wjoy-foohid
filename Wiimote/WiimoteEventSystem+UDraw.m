...
- (void)WiimoteUDrawPenPositionChangedNotification:
    (NSNotification *)notification
{
    NSPoint position = [[[notification userInfo]
        objectForKey:WiimoteUDrawPenPositionKey] pointValue];
    CGFloat pressure = [[[notification userInfo]
        objectForKey:WiimoteUDrawPenPressureKey] doubleValue];
