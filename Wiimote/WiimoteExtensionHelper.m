...
- (void)initializeExtensionPort
{
    ...
    [m_IOManager writeMemory:WiimoteDeviceRoutineExtensionInitAddress1
                        data:&data
                      length:sizeof(data)];
    usleep(50000);

    data = WiimoteDeviceRoutineExtensionInitValue2;
    [m_IOManager writeMemory:WiimoteDeviceRoutineExtensionInitAddress2
                        data:&data
                      length:sizeof(data)];
    usleep(50000);
...
- (void)beginProbe { [self retain]; }

- (void)endProbe { [self autorelease]; }
