...
{
    CGFloat newX = (((CGFloat)x) - ((CGFloat)m_ZeroX)) /
                   (((CGFloat)m_1gX) - ((CGFloat)m_ZeroX));
    CGFloat newY = (((CGFloat)y) - ((CGFloat)m_ZeroY)) /
                   (((CGFloat)m_1gY) - ((CGFloat)m_ZeroY));
    CGFloat newZ = (((CGFloat)z) - ((CGFloat)m_ZeroZ)) /
                   (((CGFloat)m_1gZ) - ((CGFloat)m_ZeroZ));
...
{
    uint16_t zeroX = (((uint16_t)calibrationData->zero.x) << 2) |
                     ((calibrationData->zero.additionalXYZ >> 0) & 0x3);
    uint16_t zeroY = (((uint16_t)calibrationData->zero.y) << 2) |
                     ((calibrationData->zero.additionalXYZ >> 2) & 0x3);
    uint16_t zeroZ = (((uint16_t)calibrationData->zero.z) << 2) |
                     ((calibrationData->zero.additionalXYZ >> 4) & 0x3);

    uint16_t gX = (((uint16_t)calibrationData->oneG.x) << 2) |
                  ((calibrationData->oneG.additionalXYZ >> 0) & 0x3);
    uint16_t gY = (((uint16_t)calibrationData->oneG.y) << 2) |
                  ((calibrationData->oneG.additionalXYZ >> 2) & 0x3);
    uint16_t gZ = (((uint16_t)calibrationData->oneG.z) << 2) |
                  ((calibrationData->oneG.additionalXYZ >> 4) & 0x3);
...
{
    return (m_ZeroX == 0 || m_ZeroY == 0 || m_ZeroZ == 0);
}

- (BOOL)isHardware1gValuesInvalid
{
    return (m_1gX == 0 || m_1gY == 0 || m_1gZ == 0);
}
...
- (void)setGravityX:(CGFloat)x y:(CGFloat)y z:(CGFloat)z
{
    x = (((CGFloat)((long long)(x / m_GravitySmoothQuant))) *
         m_GravitySmoothQuant);
    y = (((CGFloat)((long long)(y / m_GravitySmoothQuant))) *
         m_GravitySmoothQuant);
    z = (((CGFloat)((long long)(z / m_GravitySmoothQuant))) *
         m_GravitySmoothQuant);
...
- (void)setPitch:(CGFloat)pitch roll:(CGFloat)roll
{
    pitch = (((CGFloat)((long long)(pitch / m_AnglesSmoothQuant))) *
             m_AnglesSmoothQuant);
    roll = (((CGFloat)((long long)(roll / m_AnglesSmoothQuant))) *
            m_AnglesSmoothQuant);
