...
- (NSString *)name { return @"Wii U Pro Controller"; }
...
- (NSPoint)normalizeStick:(WiimoteUProControllerStickType)stick
...
- (void)setStick:(WiimoteUProControllerStickType)stick
        position:(NSPoint)newPosition
{
    ...
    [[self eventDispatcher] postUProController:self
                                         stick:stick
...
- (void)setButton:(WiimoteUProControllerButtonType)button pressed:(BOOL)pressed
{
    ...
    if (pressed)
    {
        [[self eventDispatcher] postUProController:self buttonPressed:button];
    }
    else
    {
        [[self eventDispatcher] postUProController:self buttonReleased:button];
    }
}
...
- (void)handleButtonState:(uint16_t)state
{
    ...
    } buttonMasks[] = {{WiimoteUProControllerButtonTypeA,
                        WiimoteDeviceUProControllerReportButtonMaskA},
                       {WiimoteUProControllerButtonTypeB,
                        WiimoteDeviceUProControllerReportButtonMaskB},
                       {WiimoteUProControllerButtonTypeX,
                        WiimoteDeviceUProControllerReportButtonMaskX},
                       {WiimoteUProControllerButtonTypeY,
                        WiimoteDeviceUProControllerReportButtonMaskY},
                       {WiimoteUProControllerButtonTypeUp,
                        WiimoteDeviceUProControllerReportButtonMaskUp},
                       {WiimoteUProControllerButtonTypeDown,
                        WiimoteDeviceUProControllerReportButtonMaskDown},
                       {WiimoteUProControllerButtonTypeLeft,
                        WiimoteDeviceUProControllerReportButtonMaskLeft},
                       {WiimoteUProControllerButtonTypeRight,
                        WiimoteDeviceUProControllerReportButtonMaskRight},
                       {WiimoteUProControllerButtonTypeL,
                        WiimoteDeviceUProControllerReportButtonMaskL},
                       {WiimoteUProControllerButtonTypeR,
                        WiimoteDeviceUProControllerReportButtonMaskR},
                       {WiimoteUProControllerButtonTypeZL,
                        WiimoteDeviceUProControllerReportButtonMaskZL},
                       {WiimoteUProControllerButtonTypeZR,
                        WiimoteDeviceUProControllerReportButtonMaskZR}};
...
{
    [self
        setButton:WiimoteUProControllerButtonTypeStickL
          pressed:((state &
                    WiimoteDeviceUProControllerReportButtonMaskStrickL) == 0)];

    [self
        setButton:WiimoteUProControllerButtonTypeStickR
          pressed:((state &
                    WiimoteDeviceUProControllerReportButtonMaskStrickR) == 0)];
}
...
- (void)handleReport:(const uint8_t *)extensionData length:(NSUInteger)length
{
    ...
    [self setStick:WiimoteUProControllerStickTypeLeft
          position:NSMakePoint(
                       (((CGFloat)(report->leftStrickX & 0x0FFF)) / 2048.0) -
                           1.0f,
                       (((CGFloat)(report->leftStrickY & 0x0FFF)) / 2048.0) -
                           1.0f)];

    [self setStick:WiimoteUProControllerStickTypeRight
          position:NSMakePoint(
                       (((CGFloat)(report->rightStrickX & 0x0FFF)) / 2048.0) -
                           1.0f,
                       (((CGFloat)(report->rightStrickY & 0x0FFF)) / 2048.0) -
                           1.0f)];
