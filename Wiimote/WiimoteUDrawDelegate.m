...
NSString *WiimoteUDrawPenPressedNotification =
    @"WiimoteUDrawPenPressedNotification";
NSString *WiimoteUDrawPenReleasedNotification =
    @"WiimoteUDrawPenReleasedNotification";
NSString *WiimoteUDrawPenPositionChangedNotification =
    @"WiimoteUDrawPenPositionChangedNotification";
NSString *WiimoteUDrawPenButtonPressedNotification =
    @"WiimoteUDrawPenButtonPressedNotification";
NSString *WiimoteUDrawPenButtonReleasedNotification =
    @"WiimoteUDrawPenButtonReleasedNotification";
