...
- (void)runBlock:(void (^)(void))block { block(); }
...
static WiimoteNunchuckExtension *
nunchuck_at_index(int index)
{
...
static WiimoteClassicControllerExtension *
ccontroller_at_index(int index)
{
    WiimoteExtension *e = [wiimote_at_index(index) connectedExtension];
...
static WiimoteUProControllerExtension *
upro_at_index(int index)
{
    WiimoteExtension *e = [wiimote_at_index(index) connectedExtension];
...
static WiimoteBalanceBoardExtension *
bboard_at_index(int index)
{
    WiimoteExtension *e = [wiimote_at_index(index) connectedExtension];
...
static WiimoteUDrawExtension *
udraw_at_index(int index)
{
    WiimoteExtension *e = [wiimote_at_index(index) connectedExtension];
...
static int
wiimote_get_id(Wiimote *wiimote)
{
    return [[[wiimote userInfo] objectForKey:WiimoteIDKey] intValue];
}

static void
wiimote_set_id(Wiimote *wiimote, int wid)
{
    [wiimote setUserInfo:[NSMutableDictionary
...
wmc_shutdown(void)
{
    [[WiimoteThread thread] invoke:^{
      NSArray *connectedDevices =
          [[[Wiimote connectedDevices] copy] autorelease];
...
int
wmc_is_one_button_click_connection_enabled(void)
{
    __block int result = 0;
...
int
wmc_set_one_button_click_connection_enabled(int enabled)
{
    [[WiimoteThread thread] invoke:^{
...
int
wmc_w_set_id(int index, int wid)
{
    __block int result = 0;
...
int
wmc_w_play_connect_effect(int index)
{
    __block int result = 0;
...
int
wmc_w_set_led_mask(int index, int mask)
{
    __block int result = 0;
...
int
wmc_w_is_vibration_enabled(int index)
{
    __block int result = 0;
...
int
wmc_w_set_vibration_enabled(int index, int enabled)
{
    __block int result = 0;
...
int
wmc_w_is_button_pressed(int index, int button)
{
    __block int result = 0;

    [[WiimoteThread thread] invoke:^{
      result =
          [wiimote_at_index(index) isButtonPressed:(WiimoteButtonType)button];
    }];
...
int
wmc_w_is_battery_low(int index)
{
    __block int result = 0;
...
float
wmc_w_get_battery_level(int index)
{
...
int
wmc_w_set_ir_enabled(int index, int enabled)
{
    __block int result = 0;
...
int
wmc_w_is_ir_point_out_of_view(int index, int point)
{
    __block int result = 0;
...
float
wmc_w_get_ir_point_x(int index, int point)
{
    __block float result = 0;
...
float
wmc_w_get_ir_point_y(int index, int point)
{
    __block float result = 0;
...
int
wmc_w_is_accelerometer_enabled(int index)
{
    __block int result = 0;
...
int
wmc_w_set_accelerometer_enabled(int index, int enabled)
{
    __block int result = 0;
...
float
wmc_w_get_accelerometer_x(int index)
{
    __block float result = 0;
...
float
wmc_w_get_accelerometer_y(int index)
{
    __block float result = 0;
...
float
wmc_w_get_accelerometer_z(int index)
{
    __block float result = 0;
...
float
wmc_w_get_accelerometer_pitch(int index)
{
    __block float result = 0;
...
float
wmc_w_get_accelerometer_roll(int index)
{
    __block float result = 0;
...
int
wmc_w_is_nunchuck_connected(int index)
{
    __block int result = 0;
...
int
wmc_w_is_nunchuck_button_pressed(int index, int button)
{
    __block int result = 0;

    [[WiimoteThread thread] invoke:^{
      result = [nunchuck_at_index(index)
          isButtonPressed:(WiimoteNunchuckButtonType)button];
    }];
...
float
wmc_w_get_nunchuck_stick_x(int index)
{
    __block float result = 0;
...
float
wmc_w_get_nunchuck_stick_y(int index)
{
    __block float result = 0;
...
int
wmc_w_is_nunchuck_accelerometer_enabled(int index)
{
    __block int result = 0;
...
int
wmc_w_set_nunchuck_accelerometer_enabled(int index, int enabled)
{
    __block int result = 0;
...
float
wmc_w_get_nunchuck_accelerometer_x(int index)
{
    __block float result = 0;
...
float
wmc_w_get_nunchuck_accelerometer_y(int index)
{
    __block float result = 0;
...
float
wmc_w_get_nunchuck_accelerometer_z(int index)
{
    __block float result = 0;
...
float
wmc_w_get_nunchuck_accelerometer_pitch(int index)
{
    __block float result = 0;
...
float
wmc_w_get_nunchuck_accelerometer_roll(int index)
{
    __block float result = 0;
...
int
wmc_w_is_ccontroller_connected(int index)
{
    __block int result = 0;
...
int
wmc_w_is_ccontroller_button_pressed(int index, int button)
{
    __block int result = 0;

    [[WiimoteThread thread] invoke:^{
      result = [ccontroller_at_index(index)
          isButtonPressed:(WiimoteClassicControllerButtonType)button];
    }];
...
float
wmc_w_get_ccontroller_stick_x(int index, int stick)
{
    __block float result = 0;

    [[WiimoteThread thread] invoke:^{
      result = [ccontroller_at_index(index)
                   stickPosition:(WiimoteClassicControllerStickType)stick]
                   .x;
    }];
...
float
wmc_w_get_ccontroller_stick_y(int index, int stick)
{
    __block float result = 0;
...
float
wmc_w_get_ccontroller_shift(int index, int shift)
{
    __block float result = 0;

    [[WiimoteThread thread] invoke:^{
      result = [ccontroller_at_index(index)
          analogShiftPosition:(WiimoteClassicControllerAnalogShiftType)shift];
    }];
...
int
wmc_w_is_upro_connected(int index)
{
    __block int result = 0;
...
int
wmc_w_is_upro_button_pressed(int index, int button)
{
    __block int result = 0;

    [[WiimoteThread thread] invoke:^{
      result = [upro_at_index(index)
          isButtonPressed:(WiimoteUProControllerButtonType)button];
    }];
...
float
wmc_w_get_upro_stick_x(int index, int stick)
{
    __block float result = 0;

    [[WiimoteThread thread] invoke:^{
      result = [upro_at_index(index)
                   stickPosition:(WiimoteUProControllerStickType)stick]
                   .x;
    }];
...
float
wmc_w_get_upro_stick_y(int index, int stick)
{
    __block float result = 0;
...
int
wmc_w_is_bboard_connected(int index)
{
    __block int result = 0;
...
float
wmc_w_get_bboard_press(int index, int point)
{
    __block float result = 0;
...
int
wmc_w_is_udraw_connected(int index)
{
    __block int result = 0;
...
int
wmc_w_is_pen_pressed(int index)
{
    __block int result = 0;
...
int
wmc_w_is_pen_button_pressed(int index)
{
    __block int result = 0;
