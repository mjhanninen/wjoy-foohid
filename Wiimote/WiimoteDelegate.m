...
NSString *WiimoteButtonReleasedNotification =
    @"WiimoteButtonReleasedNotification";
NSString *WiimoteVibrationStateChangedNotification =
    @"WiimoteVibrationStateChangedNotification";
NSString *WiimoteHighlightedLEDMaskChangedNotification =
    @"WiimoteHighlightedLEDMaskChangedNotification";
NSString *WiimoteBatteryLevelUpdatedNotification =
    @"WiimoteBatteryLevelUpdatedNotification";
NSString *WiimoteIREnabledStateChangedNotification =
    @"WiimoteIREnabledStateChangedNotification";
NSString *WiimoteIRPointPositionChangedNotification =
    @"WiimoteIRPointPositionChangedNotification";
NSString *WiimoteAccelerometerEnabledStateChangedNotification =
    @"WiimoteAccelerometerEnabledStateChangedNotification";
NSString *WiimoteAccelerometerGravityChangedNotification =
    @"WiimoteAccelerometerGravityChangedNotification";
NSString *WiimoteAccelerometerAnglesChangedNotification =
    @"WiimoteAccelerometerAnglesChangedNotification";
NSString *WiimoteExtensionConnectedNotification =
    @"WiimoteExtensionConnectedNotification";
NSString *WiimoteExtensionDisconnectedNotification =
    @"WiimoteExtensionDisconnectedNotification";
...
NSString *WiimoteAccelerometerEnabledStateKey =
    @"WiimoteAccelerometerEnabledStateKey";
...
- (void)wiimote:(Wiimote *)wiimote
    vibrationStateChanged:(BOOL)isVibrationEnabled
{
}
...
- (void)wiimote:(Wiimote *)wiimote
    batteryLevelUpdated:(CGFloat)batteryLevel
                  isLow:(BOOL)isLow
{
}
...
- (void)wiimote:(Wiimote *)wiimote
    irPointPositionChanged:(WiimoteIRPoint *)point
{
}
