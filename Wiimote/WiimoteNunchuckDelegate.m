...
NSString *WiimoteNunchuckButtonPressedNotification =
    @"WiimoteNunchuckButtonPressedNotification";
NSString *WiimoteNunchuckButtonReleasedNotification =
    @"WiimoteNunchuckButtonReleasedNotification";
NSString *WiimoteNunchuckStickPositionChangedNotification =
    @"WiimoteNunchuckStickPositionChangedNotification";
NSString *WiimoteNunchuckAccelerometerEnabledStateChangedNotification =
    @"WiimoteNunchuckAccelerometerEnabledStateChangedNotification";
NSString *WiimoteNunchuckAccelerometerGravityChangedNotification =
    @"WiimoteNunchuckAccelerometerGravityChangedNotification";
NSString *WiimoteNunchuckAccelerometerAnglesChangedNotification =
...
NSString *WiimoteNunchuckAccelerometerEnabledStateKey =
    @"WiimoteNunchuckAccelerometerEnabledStateKey";
NSString *WiimoteNunchuckAccelerometerGravityXKey =
    @"WiimoteNunchuckAccelerometerGravityXKey";
NSString *WiimoteNunchuckAccelerometerGravityYKey =
    @"WiimoteNunchuckAccelerometerGravityYKey";
NSString *WiimoteNunchuckAccelerometerGravityZKey =
    @"WiimoteNunchuckAccelerometerGravityZKey";
NSString *WiimoteNunchuckAccelerometerPitchKey =
    @"WiimoteNunchuckAccelerometerPitchKey";
NSString *WiimoteNunchuckAccelerometerRollKey =
