...
+ (NSArray *)extensionSignatures
{
    ...
    static const uint8_t signature2[] = {0x01, 0x00, 0xA4,
                                         0x20, 0x01, 0x01}; // Pro
...
- (NSString *)name { return @"Classic Controller"; }
...
- (NSPoint)normalizeStick:(WiimoteClassicControllerStickType)stick
                 position:(NSPoint)position
{
    return position;
}

- (CGFloat)normalizeAnalogShift:(WiimoteClassicControllerAnalogShiftType)shift
                       position:(CGFloat)position
{
    return position;
}

- (void)setStick:(WiimoteClassicControllerStickType)stick
        position:(NSPoint)newPosition
{
    ...
    [[self eventDispatcher] postClassicController:self
                                            stick:stick
                                  positionChanged:newPosition];
}

- (void)setButton:(WiimoteClassicControllerButtonType)button
...
- (void)setAnalogShift:(WiimoteClassicControllerAnalogShiftType)shift
              position:(CGFloat)newPosition
{
...
- (void)handleButtonState:(WiimoteDeviceClassicControllerButtonState)state
{
    ...
    } buttonMasks[] = {{WiimoteClassicControllerButtonTypeA,
                        WiimoteDeviceClassicControllerReportButtonMaskA},
                       {WiimoteClassicControllerButtonTypeB,
                        WiimoteDeviceClassicControllerReportButtonMaskB},
                       {WiimoteClassicControllerButtonTypeMinus,
                        WiimoteDeviceClassicControllerReportButtonMaskMinus},
                       {WiimoteClassicControllerButtonTypeHome,
                        WiimoteDeviceClassicControllerReportButtonMaskHome},
                       {WiimoteClassicControllerButtonTypePlus,
                        WiimoteDeviceClassicControllerReportButtonMaskPlus},
                       {WiimoteClassicControllerButtonTypeX,
                        WiimoteDeviceClassicControllerReportButtonMaskX},
                       {WiimoteClassicControllerButtonTypeY,
                        WiimoteDeviceClassicControllerReportButtonMaskY},
                       {WiimoteClassicControllerButtonTypeUp,
                        WiimoteDeviceClassicControllerReportButtonMaskUp},
                       {WiimoteClassicControllerButtonTypeDown,
                        WiimoteDeviceClassicControllerReportButtonMaskDown},
                       {WiimoteClassicControllerButtonTypeLeft,
                        WiimoteDeviceClassicControllerReportButtonMaskLeft},
                       {WiimoteClassicControllerButtonTypeRight,
                        WiimoteDeviceClassicControllerReportButtonMaskRight},
                       {WiimoteClassicControllerButtonTypeL,
                        WiimoteDeviceClassicControllerReportButtonMaskL},
                       {WiimoteClassicControllerButtonTypeR,
                        WiimoteDeviceClassicControllerReportButtonMaskR},
                       {WiimoteClassicControllerButtonTypeZL,
                        WiimoteDeviceClassicControllerReportButtonMaskZL},
                       {WiimoteClassicControllerButtonTypeZR,
                        WiimoteDeviceClassicControllerReportButtonMaskZR}};

    for (NSUInteger i = 0; i < WiimoteClassicControllerButtonCount; i++)
        [self setButton:buttonMasks[i].type
                pressed:((state & buttonMasks[i].mask) == 0)];
}
...
- (void)handleAnalogData:(const uint8_t *)analogData
{
    ...
    uint8_t leftShift =
        ((analogData[3] >> 5) & 0x07) | ((analogData[2] & 0x60) >> 2);

    NSPoint stickPosition;
    CGFloat analogShiftPosition;

    WiimoteDeviceNormalizeStick(leftStickX, leftStickY,
                                m_CalibrationData.leftStick, stickPosition);
    [self setStick:WiimoteClassicControllerStickTypeLeft
          position:stickPosition];

    WiimoteDeviceNormalizeStick(rightStickX, rightStickY,
                                m_CalibrationData.rightStick, stickPosition);
    [self setStick:WiimoteClassicControllerStickTypeRight
          position:stickPosition];

    WiimoteDeviceNormilizeShift(leftShift, 0, 15, 31, analogShiftPosition);
    [self setAnalogShift:WiimoteClassicControllerAnalogShiftTypeLeft
                position:analogShiftPosition];

    WiimoteDeviceNormilizeShift(rightShift, 0, 15, 31, analogShiftPosition);
    [self setAnalogShift:WiimoteClassicControllerAnalogShiftTypeRight
                position:analogShiftPosition];
}
...
- (void)handleReport:(const uint8_t *)extensionData length:(NSUInteger)length
{
    ...
    WiimoteDeviceClassicControllerButtonState state =
        OSSwapBigToHostConstInt16(classicReport->buttonState);
