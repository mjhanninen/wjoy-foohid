...
NSString *WiimoteUProControllerButtonPressedNotification =
    @"WiimoteUProControllerButtonPressedNotification";
NSString *WiimoteUProControllerButtonReleasedNotification =
    @"WiimoteUProControllerButtonReleasedNotification";
NSString *WiimoteUProControllerStickPositionChangedNotification =
...
NSString *WiimoteUProControllerStickPositionKey =
