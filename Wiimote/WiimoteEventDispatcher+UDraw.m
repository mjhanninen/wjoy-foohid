              ...
              pressure:(CGFloat)pressure
{
    ...
    if ([self isStateNotificationsEnabled])
    {
        NSDictionary *params = [NSDictionary
            dictionaryWithObjectsAndKeys:[NSValue valueWithPoint:position],
                                         WiimoteUDrawPenPositionKey,
                                         [NSNumber numberWithDouble:pressure],
                                         WiimoteUDrawPenPressureKey, nil];
