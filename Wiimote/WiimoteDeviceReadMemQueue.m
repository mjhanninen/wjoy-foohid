...
- (BOOL)readMemory:(NSRange)memoryRange target:(id)target action:(SEL)action
{
    ...
    WiimoteDeviceReadMemHandler *handler = [[[WiimoteDeviceReadMemHandler alloc]
...
- (void)handleReport:(WiimoteDeviceReport *)report
{
    ...
    NSUInteger dataSize = ((memoryReport->errorAndDataSize &
                           ...
                           WiimoteDeviceReadMemoryReportDataSizeOffset) +
                          1;
...
- (BOOL)isQueueEmpty { return ([m_ReadMemHandlersQueue count] == 0); }
