...
NSString *WiimoteBalanceBoardPressChangedNotification =
    @"WiimoteBalanceBoardPressChangedNotification";

NSString *WiimoteBalanceBoardTopLeftPressKey =
    @"WiimoteBalanceBoardTopLeftPressKey";
NSString *WiimoteBalanceBoardTopRightPressKey =
    @"WiimoteBalanceBoardTopRightPressKey";
NSString *WiimoteBalanceBoardBottomLeftPressKey =
    @"WiimoteBalanceBoardBottomLeftPressKey";
NSString *WiimoteBalanceBoardBottomRightPressKey =
    @"WiimoteBalanceBoardBottomRightPressKey";
