...
static int
doCommandWithPath(const char *cmd, const char *path)
{
    NSString *command = [NSString
        stringWithFormat:@"%@ \"%@\"", [NSString stringWithUTF8String:cmd],
...
static BOOL
repairDriverRihts(const char *path)
{
